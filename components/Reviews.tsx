               ...
               {[1, 2, 3, 4, 5].map((item: number) => {
                  return (
                     <SwiperSlide key={item}>
                        <div className="relative flex max-lg:flex-col gap-12 max-xl:gap-10 max-lg:gap-6 px-16 max-lg:px-10">
                           <div className="w-[70%] max-lg:w-full h-[500px] max-lg:h-[600px] rounded-3xl bg-black">
                              <div className=""></div>
                           </div>
